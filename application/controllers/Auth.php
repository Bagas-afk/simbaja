...
class Auth extends CI_Controller {
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('noktp', 'ktp', 'required|trim|numeric|max_length[16]|min_length[16]|is_unique[user.no_ktp]', [
      ...
      if ($this->form_validation->run() == false) {
          ...
          $data= [
              ...
              'no_ktp' => htmlspecialchars($this->input->post('noktp', true)),
